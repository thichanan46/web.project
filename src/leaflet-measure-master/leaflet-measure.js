!(function (e) {
  ...
  function (e, t, r) {
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      _getMeasurementDisplayStrings: function (e) {
        ...
        function areaMeterToRai(meter){
          meter = Math.round(meter)
          let rai = meter/1600
          let ngan = (rai - Math.floor(rai))*4
          let wah = Math.round((ngan - Math.floor(ngan))*100)
          return `${Math.floor(rai)} ไร่ ${Math.round(ngan)} งาน ${wah} ตารางวา`
        }
        return {
          lengthDisplay: t(
            e.length,
          ...
          areaRai: areaMeterToRai(Math.round(e.area)),
        };
      },
  ...
  function (e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="วัดระยะทางและพื้นที่"><i class="bx bx-shape-polygon"></i></a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>วัดระยะทางและพื้นที่</h3> <ul class=tasks> <a href=# class="js-start start">สร้างการวัดใหม่</a> </ul> </div> <div class=js-measuringprompt> <h3>วัดระยะทางและพื้นที่</h3> <p class=js-starthelp>เริ่มวัดโดยการคลิ้กที่แผนที่</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">ยกเลิก</a></li> <li><a href=# class="js-finish finish">เสร็จสิ้นการวัด</a></li> </ul> </div> </div> ';
  },
  function (e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">จุดล่าสุด</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>ระยะทาง</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>พื้นที่</span> {{ model.areaDisplay }}</p> <p><span class=heading>พื้นที่(ไร่)</span> {{ model.areaRai }}</p> </div> <% } %> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>ตำแหน่งของจุด</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">ไปที่จุด</a></li> <li><a href=# class="js-deletemarkup deletemarkup">ลบ</a></li> </ul> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>ข้อมูลระยะทาง</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">จุดกึ่งกลางของเส้น</a></li> <li><a href=# class="js-deletemarkup deletemarkup">ลบ</a></li> </ul> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>ข้อมูลพื้นที่และระยะทาง</h3> <p><span class=heading>พื้นที่</span> {{ model.areaDisplay }}</p> <p><span class=heading>พื้นที่(ไร่)</span> {{ model.areaRai }}</p> <p><span class=heading>ระยะทาง</span> {{ model.lengthDisplay }} </p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">จุดกึ่งกลางของพื้นที่</a></li> <li><a href=# class="js-deletemarkup deletemarkup">ลบ</a></li> </ul> ';
  },
]);
